...
Canvas: ручка поворота под выделением и точка связи на середине каждой стороны.
При наведении точка становится стрелкой наружу: клик добавляет связанную ноду с
этой стороны, перетаскивание тянет связь. Поворот показывается на месте и
