...
- [ ] `FUT-016` `P1 P` Шрифты. База сделана 2026-09-24: в списке только
  ...
  подходящий набор или сам этот шрифт. Выпуск на GitHub (метка `fonts-1`) с
  самими архивами наборов пока не опубликован; до тех пор скачивание прямо
  говорит «этот набор ещё не выложен» вместо ошибки.
