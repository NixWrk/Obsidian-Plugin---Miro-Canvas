...
3. **Доставка и мастер импорта:** плагин в отдельном репозитории, связанный с
   ...
   (`FUT-003`, `FUT-014`).
4. **Знакомство с плагином:** ознакомительная доска по желанию (`FUT-011`), затем
   визуальное описание функций и порядка настройки на обоих языках, со снимками
   с этой доски (`FUT-012`).
5. **Проверка на людях:** полный путь пользователя на чистой Windows и
   исправления (`FUT-004`); затем другие ОС, телефоны и планшеты (`FUT-010`).
6. **Экосистема:** MCP-сервер рядом со скиллом (`FUT-007`), импорт из других
   плагинов (`FUT-009`), ускорение перетаскивания на огромных досках, остальные
   мелкие ограничения.
