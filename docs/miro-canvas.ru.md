...
- [ ] `FUT-016` `P1 P` Шрифты. База сделана 2026-09-24: в списке только
  ...
  `fonts-1` на GitHub; его собирает и публикует
  ...
  проверка обновлений, и BRAT, который прочёл бы `fonts-1` как версию
  1.0.0. Если набора в выпуске нет, скачивание прямо говорит «этот набор
