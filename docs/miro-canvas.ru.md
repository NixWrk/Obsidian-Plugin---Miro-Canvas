...
- [ ] `FUT-019` `P1 P` Настройка панелей прямо на доске (расширено
  2026-09-25 по просьбе пользователя): особый режим, включаемый из угловой
  панели, в котором нижнюю панель, угловую панель, миникарту и панель
  форматирования можно перетащить куда угодно на экране, а инструменты
  внутри нижней панели - переставить, убрать с неё или добавить из лотка
  инструментов, которых на ней нет. Это удобнее списка в настройках (список
  остаётся). Положения запоминаются.
