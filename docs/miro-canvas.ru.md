...
- [ ] `FUT-022` `P1 P` Обновления. Правила Obsidian запрещают плагину
  ...
  обычной проверкой обновлений Obsidian. В самом плагине - кнопка «Проверить
  обновления» в настройках: по нажатию сравнивает версию с последним выпуском
  на GitHub и показывает, что нового, со ссылкой; ничего не скачивает и без
  нажатия в сеть не ходит.
