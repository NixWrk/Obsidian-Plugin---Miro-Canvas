...
- [x] `FUT-018` `P1 P` Нижняя панель инструментов. Вернуть в быстрый доступ
  ...
  продолжают работать; у стикера теперь свой жёлтый значок с загнутым
  уголком вместо значка-контура, который совпадал со значком карточки;
...
- [ ] `FUT-019` `P2 P` Положение панелей: нижнюю панель инструментов и угловую
  панель (миникарта, масштаб, настройки доски) можно перетащить в удобное
  место экрана; положение запоминается.
